...
public class RestTestUtils {
    ...
    public static Request buildHttpRequest(GetAsyncSearchRequest getAsyncSearchRequest) {
        Request request = new Request(HttpGet.METHOD_NAME, AsyncSearchPlugin.BASE_URI + "/" + getAsyncSearchRequest.getId());
        Params params = new Params();
    ...
    public static Request buildHttpRequest(DeleteAsyncSearchRequest deleteAsyncSearchRequest) {
        return new Request(HttpDelete.METHOD_NAME, AsyncSearchPlugin.BASE_URI + "/" + deleteAsyncSearchRequest.getId());
    }
