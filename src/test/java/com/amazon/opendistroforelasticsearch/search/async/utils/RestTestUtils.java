...
public class RestTestUtils {
    ...
    static Request buildHttpRequest(
        ...
        Request request = new Request(HttpPost.METHOD_NAME, endpoint(searchRequest.indices(),
                searchRequest.types(), "_async_search"));

        Params params = new Params();
        addSearchRequestParams(params, searchRequest);
        addSubmitAsyncSearchRequestParams(params, submitAsyncSearchRequest);
    ...
    public static Request buildHttpRequest(GetAsyncSearchRequest getAsyncSearchRequest) {
        Request request = new Request(HttpGet.METHOD_NAME, "/_async_search/"+getAsyncSearchRequest.getId());
        Params params = new Params();
        addGetAsyncSearchRequestParams(params, getAsyncSearchRequest);
        request.addParameters(params.asMap());
        return request;
    }

    public static Request buildHttpRequest(DeleteAsyncSearchRequest deleteAsyncSearchRequest) {
        return new Request(HttpDelete.METHOD_NAME, "/_async_search/"+deleteAsyncSearchRequest.getId());
    }
