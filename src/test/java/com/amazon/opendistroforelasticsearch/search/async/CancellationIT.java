...
import static com.amazon.opendistroforelasticsearch.search.async.CancellationIT.ScriptedBlockPlugin.SCRIPT_NAME;
...
public class CancellationIT extends ESIntegTestCase {
    ...
    private void cancelSearch(String action) {
        ...
        assertThat(listTasksResponse.getTasks(), hasSize(2));
        TaskInfo searchTask = listTasksResponse.getTasks().get(1);
    ...
    public void testCancellationDuringQueryPhase() throws Exception {
        ...
        cancelSearch(SubmitAsyncSearchAction.NAME);
